...
export const getTokenCount = async (
  ...
  // All messages in the request payload are input (prompt) tokens.
  // Historical assistant messages are part of the prompt context — they are
  // NOT output tokens.  Output tokens are generated by the model in its
  // response and are not present in the request.
